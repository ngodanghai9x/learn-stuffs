...
cron.schedule(CronExpression.EVERY_10_SECONDS, async () => {
  console.log(CronExpression.EVERY_10_SECONDS, new Date());
});

console.log(cron.validate(CronExpression.EVERY_10_SECONDS))
console.log(cron.validate(CronExpression.EVERY_10_MINUTES))
console.log(cron.validate(CronExpression.EVERY_10_HOURS))
