...
var run = async () => {
  var values = await Promise.allSettled([resolve, reject, resolve2()]).then(data => {
...

{
  ...
  const test2 = async () => {
    console.log(1)
    await Promise.resolve(2).then(console.log).finally(() => console.log('Promise finally'))
    console.log(3)
  }
  test()
  test2()
